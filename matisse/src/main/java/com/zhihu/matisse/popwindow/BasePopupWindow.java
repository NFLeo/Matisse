...
public abstract class BasePopupWindow implements BasePopup, PopupWindow.OnDismissListener, PopupController {
    ...
    private void tryToShowPopup(View v) {
        try {
            ...
            Log.e(TAG, "show loadingview_error");
            e.printStackTrace();
        }
    }
    ...
    public void dismiss() {
        try {
            ...
            Log.e(TAG, "dismiss loadingview_error");
        }
    }
    ...
    protected AnimatorSet getDefaultSlideFromTopAnimationSet() {
        return SimpleAnimUtil.getDefaultSlideFromTopAnimationSet(mAnimaView);
    }
